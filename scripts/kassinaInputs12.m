function kassinaInputs12(FILENAME, SAVEAS,trimStart, trimEnd, fixed)
%generates joint quaternions from markers
% If fixed=true, then lateral IS movement is set to 0
...
if nargin<1
    ...
    FILENAME = ['Z:/DATA/FrogKinematics/Kassina/'...
               'xyzPOINTS/Jumping/KM07_HOP_11_xyzPOINTS.dat'];
        %FILENAME = 'Z:\DATA\FrogKinematics\Kassina\xyzPOINTS\Jumping\Sept2016\KM03_HOP_02_xyzPOINTS.dat';
...
[data_t,TM] = transformFrogData12(data);
...
if fixed  % THIS CONTROLS WHETHER THE IS JOINT IS FIXED IN LATERAL PLANE
    vecPelvis(:,1) =   0;
else 
