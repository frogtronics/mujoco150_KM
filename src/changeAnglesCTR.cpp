...
char *ffile = (char*)"blah";
char *ifile = (char*)"blah";
char *tfile = (char*)"blah";
...
int main(int argc, const char** argv)
{
	...
	// 	inputFile = fopen("../input/KM04_HOP_07_freeball.txt", "r");
	// if (!inputFile) {
	// 	printf("Could not open input file, fool %s\n",ifile);
	// 	return 1;
	// }
	inputFile = fopen("../input/KM04_HOP_07_freeball.txt", "r");
	...
	// 	}
	// }
	tendonFile = fopen("../input/tendondata.txt", "w");
